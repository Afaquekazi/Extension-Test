...
// FIXED: Remove double deduction - only check, don't deduct
async function checkCredits(mode) {
    try {
        ...
        // ❌ REMOVED: Don't deduct credits here - let backend handle it
        // const deductResult = await BackendAuth.deductCredits(mode);
        
        // ✅ FIXED: Only check if user has enough credits
        return { 
            success: true, 
